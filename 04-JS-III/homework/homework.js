...
var array2=[]
for (let index = 0; index < array.length; index++) {
   if ("Enero"=== array[index]|| "Marzo"=== array[index] ||"Noviembre"=== array[index]){
...
function continueStatement(numero) {
  ...
  //Guardar cada nuevo valor en un array.    
  //Devolver el array
  //Cuando el número de iteraciones alcance el valor 5, n
 // o se suma en ese caso y se continua con la siguiente iteración
